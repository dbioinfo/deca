...
saveRDS(tf, 'data/cyano/cyano_faprotax_abund.rds')
```
...
ha <- HeatmapAnnotation(
  Microhabitat = anno_block(
    labels = unique(as.character(m2$Microhabitat)),
...
col_fun <- colorRamp2(c(0, max(mat)), colors=c("#f0f0f0", "#33857B" ))
...
ht <- Heatmap(
  ...
  top_annotation       = ha,
  col                  = col_fun,
  column_split = m2[,c('Microhabitat')],
...
png("figs/cyano_faprotax_heatmap.png", width = 5000, height = 3000, res = 300)
