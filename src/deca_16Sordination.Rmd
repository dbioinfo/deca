...
sout <- metaMDS(sX,
               ...
               parallel=80,
               maxit=300)
saveRDS(sout, 'data/16Svegan/deca_surface_bray_nmds.rds')
ssout <- metaMDS(ssX,
               k=3,
               wascores = T,
               weakties=T,
               ...
               parallel=80,
               maxit=300)
saveRDS(ssout, 'data/16Svegan/deca_suburface_bray_nmds.rds')
...
unweighted <- UniFrac(ps, weighted = F, parallel = T)

#save results
saveRDS(unweighted, "data/16Svegan/unifrac.dist.rds")
...
out <- metaMDS(unweighted,
               ...
               parallel=80,
               maxit=300)
saveRDS(out, 'data/16Svegan/deca_unifrac_nmds.rds')
```
...
sX <- UniFrac(subset_samples(ps, sample_names(ps) %in% sidx)  , weighted = F, parallel = T)
saveRDS(sX, 'data/16Svegan/surface.unifrac.dist.rds')

ssX <- UniFrac(subset_samples(ps, sample_names(ps) %in% sidx)  , weighted = F, parallel = T)
saveRDS(ssX, 'data/16Svegan/subsurface.unifrac.dist.rds')
...
sout <- metaMDS(sX,
               ...
               parallel=80,
               maxit=300)
saveRDS(sout, 'data/16Svegan/deca_surface_unifrac_nmds.rds')
ssout <- metaMDS(ssX,
               k=3,
               wascores = T,
               weakties=T,
               ...
               parallel=80,
               maxit=300)
saveRDS(ssout, 'data/16Svegan/deca_suburface_unifrac_nmds.rds')
